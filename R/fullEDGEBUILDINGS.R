...
fullEDGEBUILDINGS <- function(rev = 0) {
  ...
  calcOutput("ACOwnershipRatesFilled",                                  file = "f_acOwnershipRates.cs4r")
  calcOutput("ACOwnershipRegression", aggregate = FALSE,                file = "f_acOwnershipRegression.cs4r")
  ...
  calcOutput("FloorspacePast", returnPars = TRUE,       aggregate = FALSE, file = "f_floorspace_coefs.cs4r")
  ...
  calcOutput("ElecDemandICT",                                          file = "f_elecICT.cs4r")
}
